...
of Rust newer than 1.27.0, as well as the latest beta and the latest nightly.
If either crate fails to compile on any version newer than 1.27.0, please open
an issue.
